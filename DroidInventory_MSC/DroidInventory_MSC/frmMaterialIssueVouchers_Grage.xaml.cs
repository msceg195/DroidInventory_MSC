    ...
    public partial class frmMaterialIssueVouchers_Grage : ContentPage
    {
        ...
        private void btnIssueRequesition_Clicked(object sender, EventArgs e)
        {
            ...
            _page.SharedMaterialRequesitionsList.ItemSelected += (source, args) =>
            {
                ...
                GetMaterialRequesitionsDetails(_s.RequesitionID, (Application.Current as App).ConName);
                Navigation.PopAsync();
            };
            Navigation.PushAsync(_page);
        }

        private async void GetMaterialRequesitionsDetails(int RequesitionID, string CN)
        {

            string url = (Application.Current as App).APIUrl + "SC_MaterialIssueRequesitions?id=" + RequesitionID.ToString() + "&CN=" + CN;
